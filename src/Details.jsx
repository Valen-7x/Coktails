...
<div className='flex flex-col items-center w-[60vh] '>
  ...
  <div className='flex flex-col justify-center pb-[1rem] pr-[1rem] w-[60vh] h-[55vh] md:w-[60vh] md:h-[60vh] gap-5 ml-[2rem] rounded-2xl'>
    ...
    <div>
      <b>Ingredients:  </b> 
    <b>{drinki.drinks?.[0].strIngredient1}, </b> 
    <b> {drinki.drinks?.[0].strIngredient2}, </b>
